...
class FlowerClient(fl.client.NumPyClient):
    ...
    def get_properties(self, config):
        return {"Modality": self.modality, "num_examples": self.num_examples}
    ...
    def train(self, model, trainloader: DataLoader, epochs=1, lr=1e-3):
        ...
        for epoch in range(epochs):
            ...
            for i, (images, masks) in enumerate(trainloader):
                ...
                if i == 0:  
                    predicted_masks = outputs > self.thr
        ...
        self.evaluate(self.get_parameters(config={}))
    ...
    def test(self, net, testloader):
        ...
        avg_dice = total_dice / len(testloader)
        avg_ahd = total_ahd / len(testloader)
    ...
    def IoU(self, predicted_masks, masks):
        ...
        union = (predicted_masks | masks).float().sum((1, 2, 3))
