...
def divide_images_and_masks(dataset_name, path, number_img_server_test, number_img_server_train_reduced, number_img_server_test_reduced, split, split_test_clients, dict_name, output_dir):
    ...
    if number_img_server_test_reduced != 0 and number_img_server_test != 0 and number_img_server_train_reduced != 0:
        test_server_reduced_patients, test_server_reduced_images, patient_data, selected_patients_test_server_reduced = select_patient_combination_with_closest_images_and_masks(patient_data, number_img_server_test_reduced) 
        ...
        train_server_reduced_patients, train_server_reduced_images, patient_data, selected_patients_train_server_reduced = select_patient_combination_with_closest_images_and_masks(patient_data, number_img_server_train_reduced)

    train_client, test_client, num_imgs_train, num_imgs_test = split_for_client(patient_data, split)
    if number_img_server_test_reduced != 0 and number_img_server_test != 0 and number_img_server_train_reduced != 0:
        print(f"Test server reduced: {test_server_reduced_images} images")
        print(f"Train server reduced:  {train_server_reduced_images} images")
    ...
    if number_img_server_test_reduced != 0 and number_img_server_test != 0 and number_img_server_train_reduced != 0:
        dict_data= {
            ...
            "train_server_reduced": selected_patients_train_server_reduced,
            "test_server_reduced": selected_patients_test_server_reduced
        }
        ...
        dict_data = {
            ...
            "test_client": test_client,
            "test_server": 0,
            "train_server_reduced": 0,
            "test_server_reduced": 0
        }
...
for dataset_name in datasets:
    ...
    n_samples, tot_images_train1, tot_images_train2, tot_images_train3 = divide_images_and_masks(dataset_name, path, number_img_server_test, number_img_server_train_reduced, number_img_server_test_reduced, split, split_test_clients, dict_name, output_dir)
